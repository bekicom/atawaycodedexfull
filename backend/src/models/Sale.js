...
const saleItemSchema = new mongoose.Schema(
  {
    ...
    saleMode: { type: String, enum: ["base", "piece"], default: "base" },
    quantity: { type: Number, required: true, min: 0 },
    returnedQuantity: { type: Number, required: true, min: 0, default: 0 },
    baseQuantity: { type: Number, required: true, min: 0, default: 0 },
    returnedBaseQuantity: { type: Number, required: true, min: 0, default: 0 },
    stockPerUnitInBase: { type: Number, required: true, min: 0, default: 1 },
...
const saleReturnSchema = new mongoose.Schema(
  {
    ...
    shiftNumber: { type: Number, default: 0 },
